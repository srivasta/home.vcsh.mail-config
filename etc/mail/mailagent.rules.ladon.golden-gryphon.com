...
<RETRY,INITIAL> From X-Sender To Cc Sender X-Mn-Key Envelope Delivered-To X-BeenThere:
 /(acm)-pdc-announce\@ACM.ORG/i, /(acm)bulletin\@ACM\.ORG/i,
 /\@hq.(acm)\.org/i, /(acm)help@electionservicescorp.com/i,
 /william\@(gslug)\.org/i, /gslug-announce\@(gslug)\.org/i,
 ...
 /meetings\@(comsoc)\.org/i, /Reader_Survey\@(computer)\.org/i,
 /ieee-seattle\@listserv\.(ieee)\.org/i, /k\.mccabe\@(ieee)\.org/i,
 /\@bmsmail3\.(ieee)\.org/i, /IEEEservice\@(ieee)\.org/i,
 ...
 /IEEE-Annual-Election\@(ieee)\.org/i, /IEEECBP\@info1\.(ieee)\.org/i,
 /IEEE\@info1\.(ieee)\.org/i, /IEEEservice\@(ieee)\.org/i,
 /pes\@(ieee)\.org/i,
 /ieee-sa-exec\@(ieee)\.org/i,
 /\@mail\.(jetsetter)\.com/i,
 /\@(cmg)\.org/i, /\@info1\.(ieee)\.org/i, /q.brown\@(ieee)\.org/i,
 ...
 /candidate(jobs)ite\@ieee\.org/i, /careernavigator\@(ieee)\.org/i,
 /computerwise\@(ieee)\.org/i, /computing_now\@(computer)\.org/i,
 /conference-services\@(ieee)\.org/i,
 /corporate-communications\@(ieee)\.org/i,
 /csdl-newsletter\@(computer)\.org/i,
 /ieee-career-alert\@(ieee)\.org/i, /ieeemdl-help\@(ieee)\.org/i,
 /l\.book\@(ieee)\.org/i, /no-reply\@(ieee)\.org/i,
 ...
 /roboticnews\@(ieee)\.org/i, /special-mailing\@(ieee)\.org/i,
 /techinsider\@(ieee)\.org/i, /the-institute\@(ieee).org/i,
 /todaysengineer\@(ieee)\.org/i, /visibility\@(ieee)\.org/i,
 /vtools-voting\@(ieee)\.org/i, /membernet\@hq\.(acm)\.org/i,
 /\@(usenix)\.org/i, /Rudi\.van\.Drunen\@(usenix)\.org/i,
 /Thomas].Limoncelli\@(usenix)\.org/i, /Clem\.Cole\@(usenix)\.org/i,
 /Wilson\.Hsieh\@(usenix)\.org/i, /Brent\.Hoon\.Kang\@(usenix)\.org/i,
 /anne\@(usenix)\.org/i, /Adam\.Moskowitz\@(usenix)\.org/i,
 /Anne\.Dickison\@(usenix)\.org/i, /Anne_Dickison\@(usenix)\.org/i,
 /Mike_Swift\@(usenix)\.org/i, /Jeff_Chase\@(usenix)\.org/i,
 /Paul_Anderson\@(usenix)\.org/i, /office\@(usenix)\.org/i,
 /pd\@(acm)\.org/i, /(technews)\@.acm\.org/i,
 /(technews)\@.*\.acm\.org/i, /simone\.darby\@(ieee)\.org/i,
 /the-institute\@(ieee)\.org/i, /enotice\@(ieee)\.org/i,
 /Erez\.Zadok\@(usenix)\.org/i, /Ethan\.Miller\@(usenix)\.org/i,
 /Gautam\.Singaraju\@(usenix)\.org/i, /C.Rowland\@(usenix)\.org/i,
...
/\@(growingwashington)\.org/i,
 ...
 /\@(pininterest).com/i,
 /\@(sendgrid)\.net/i,
 /dolrenewalreminder\@(dol)\.wa\.gov/i,
 /noreply\@(dol)\.wa\.gov/i,
...
/\@(britishairways)\.com/i,
 ...
 /\@wellsconnect\.(wellsfaquora\.(intuit)\.com/i,
 ...
 /donotreply(seattleutilities)\@seattle\.gov/i,
